...
const TechStack = () => {
  ...
  useEffect(() => {
    // Notify GSAP that a new heavy component arrived, recalculate ScrollSmoother sizes
    setTimeout(() => {
    ...
    const handleScroll = () => {
      ...
      if (techStackEl) {
        ...
        // Trigger physics when the tech stack is within 100px of entering the viewport
